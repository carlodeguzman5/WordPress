        ...
        <div class="blog__posts mdl-grid">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <ItemTemplate>
                        <div class="mdl-card mdl-cell mdl-cell--12-col" >
                            <div class="mdl-card__media mdl-color-text--grey-50" style="vertical-align: middle; background-color: <%# Eval("primaryColor") %> ; background-image: url('http://www.wordpress.com/WordPress/Assets/BlogHeaders/<%#Eval("image")%>')">
